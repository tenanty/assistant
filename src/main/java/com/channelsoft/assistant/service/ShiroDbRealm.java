...
public class ShiroDbRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) throws AuthenticationException {
		logger.debug("进入 ShiroDbRealm.doGetAuthenticationInfo()");
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
		logger.debug("进入 ShiroDbRealm.doGetAuthorizationInfo()");
	...
	public void initCredentialsMatcher() {
		logger.debug("进入 ShiroDbRealm.initCredentialsMatcher()");
	...
	public void setAccountService(AccountService accountInfoService) {
		logger.debug("进入 ShiroDbRealm.setAccountInfoService()");
